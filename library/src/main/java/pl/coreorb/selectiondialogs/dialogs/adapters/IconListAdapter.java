...
/**
 * Standard ArrayAdapter to use with ListViews for SelectionDialogsIcon objects.
 */
public class IconListAdapter extends ArrayAdapter<SelectionDialogsIcon> {

    public IconListAdapter(Context context, ArrayList<SelectionDialogsIcon> selectionDialogsColors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SelectionDialogsIcon item = getItem(position);
